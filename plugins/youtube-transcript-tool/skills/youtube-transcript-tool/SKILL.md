---
name: skill-youtube-transcript-tool
...
- When you need to use youtube-transcript-tool CLI tool
- When you need comprehensive guidance on CLI commands
- When you need examples and troubleshooting

# youtube-transcript-tool Skill

## Purpose

<!-- TODO: Expand with specific tool capabilities -->
This skill provides access to the `youtube-transcript-tool` CLI tool. A Python CLI tool.

## When to Use This Skill

**Use this skill when:**
<!-- TODO: Add specific scenarios, e.g., -->
- You need to understand how to use youtube-transcript-tool
- You need comprehensive examples and patterns
- You need troubleshooting guidance

**Do NOT use this skill for:**
<!-- TODO: Add anti-patterns, e.g., -->
- Tasks unrelated to youtube-transcript-tool
- Quick syntax lookups (use slash commands instead)

## CLI Tool: youtube-transcript-tool

<!-- TODO: Add tool overview -->
The `youtube-transcript-tool` is a command-line interface tool that A Python CLI tool.
...
**Usage:**
```bash
youtube-transcript-tool command-name ARGUMENT [OPTIONS]
```
...
```bash
# Example 1: Basic usage
youtube-transcript-tool command-name "example"

# Example 2: With options
youtube-transcript-tool command-name "example" --option value

# Example 3: Pipeline usage
youtube-transcript-tool command-name "example" --json | jq '.'
```
...
```bash
youtube-transcript-tool --help
youtube-transcript-tool COMMAND --help
```
...
youtube-transcript-tool command -v

# DEBUG level - see detailed info
youtube-transcript-tool command -vv

# TRACE level - see all internals
youtube-transcript-tool command -vvv
```
...
youtube-transcript-tool command --json | jq '.'
```
...
- **GitHub**: https://github.com/dnvriend/youtube-transcript-tool
- **Python Package Index**: https://pypi.org/project/youtube-transcript-tool/
