...
- **Slash Commands**: Quick CLI invocations (e.g., `/youtube-transcript-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-youtube-transcript-tool`)
...
**File**: `plugins/youtube-transcript-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/youtube-transcript-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/youtube-transcript-tool/commands/<command>.md`
...
/youtube-transcript-tool:command "argument"
```

## Skills

**Location**: `plugins/youtube-transcript-tool/skills/youtube-transcript-tool/SKILL.md`
...
**Usage in Claude Code**:
```
/skill-youtube-transcript-tool
```

Or:
```
Use the skill-youtube-transcript-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/youtube-transcript-tool/commands/<command>.md`
...
3. `plugins/youtube-transcript-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/youtube-transcript-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/youtube-transcript-tool/commands/

# Check skill
cat plugins/youtube-transcript-tool/skills/youtube-transcript-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/youtube-transcript-tool:help`
3. Try skill: `/skill-youtube-transcript-tool`
